...
const SOCIALS = {
  ...
  discord: 'https://discord.gg/UyeQDSRENB',
  linkedin: 'https://www.linkedin.com/company/community-of-coders-vjti/',
  twitter: 'https://www.linkedin.com/company/community-of-coders-vjti/',
  devpost: 'https://www.linkedin.com/company/community-of-coders-vjti/',
  email: 'https://www.linkedin.com/company/community-of-coders-vjti/',
  mail: 'https://www.linkedin.com/company/community-of-coders-vjti/'
};
...
const Prizeinfo = [
  ...
  //     icon: <i className="first fas fa-4x fa-trophy"></i>,
  //     type: ' Best FY',
  //     content: 'Special prize to the best team among all the First Year students!'
  //   },
  //   {
